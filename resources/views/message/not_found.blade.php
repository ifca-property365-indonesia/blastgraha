                                ...
                                <tr>
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                        ...
                                        <div style="text-align:center; margin:0 60px 34px 60px">
                                            <!--begin:Text-->
                                            <div
                                                style="font-size: 14px; font-weight: 500; margin-bottom: 30px; font-family:Arial,Helvetica,sans-serif">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <!--begin:Title-->
                                                <h4
                                                    style="text-align:center; color:#181C32; font-size: 17px; font-weight:600; margin-bottom:25px">
                                                    NOT FOUND</h4>
                                                <!--end:Title-->
                                                ...
                                                <div style="padding-bottom:1px">
                                                    <!--begin:Item-->
                                                    <div
                                                        style="display:flex; justify-content: center; color:#5a5b61; font-size: 14px; font-weight:600">
                                                        <!--begin:Description-->
                                                        <div style="font-family:Arial,Helvetica,sans-serif;">
                                                            The transaction number is not found, please contact the administrator
                                                        </div>
                                                        <!--end:Description-->
                                                    </div>
                                                    <!--end:Item-->
